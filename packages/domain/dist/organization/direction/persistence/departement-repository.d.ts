...
export interface DepartementRepository {
    ...
    findDirectionById(directionId: string): Promise<{
        id: string;
    } | null>;
    findByTitleOrAbbreviationInDirection(title: string, abriviation: string, directionId: string): Promise<Departement | null>;
    findByIdWithUserCount(id: string): Promise<(DepartementSummary & {
        users: number;
    }) | null>;
...
//# sourceMappingURL=departement-repository.d.ts.map