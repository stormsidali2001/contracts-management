...
const StatisticsSlice = createSlice(
    {
        ...
        reducers:{
            setDateRange:(state,action:PayloadAction<{startDate?:string|null,endDate?:string|null}>)=>{
                state.start_date = action.payload.startDate ? dayjs(action.payload.startDate) : null;
                state.end_date = action.payload.endDate ? dayjs(action.payload.endDate) : null;
            },
...
export const {newCreatedUserEvent,newVendorStats,newAgreement,setDateRange} = StatisticsSlice.actions;
