    ...
    <div className={styles.container}>
      <form>
          ...
          {activeStep === 0 && (
            <>
              ...
              <TextField
                ...
                helperText={
                  nifShouldDisplayError &&
                  'format de nif: 1 caractere 7 numero 1 caractere'
                }
                size="small"
              ...
              <TextField
                ...
                helperText={nrcShouldDisplayError && 'format invalide'}
                size="small"
          ...
          {activeStep === 1 && (
            <>
              <TextField
                ...
                helperText={addressShouldDisplayError && 'champ requis'}
                size="small"
                label="adresse"
              />
              <TextField
                ...
                helperText={
                  homePhoneNumberShouldDisplayError &&
                  "ce n'est pas un numero de telephone(fixe) algerien"
                }
                size="small"
                label="fixe"
              />
              <TextField
                ...
                helperText={
                  personalPhoneNumberShouldDisplayError &&
                  "ce n'est pas un numero de telephone algerien"
                }
                size="small"
                label="mobile"
              />
        ...
        <Stack direction="row" className={styles.actionButtons}>
          <Button disabled={activeStep === 0 || (activeStep === 2 && done)}>
            Precedent
          </Button>
          <Button
            disabled={nextBtnshouldBeDisabled()}
            onClick={() =>
              activeStep !== 2 ? handleNextStep() : handleClose()
            }
          >
